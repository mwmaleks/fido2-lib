...
class Fido2Lib {
    ...
    * See [authenticatorSelection]{@link https://w3.org/TR/webauthn/#authenticatorSelection} in the WebAuthn spec for details.
    ...
    */
    ...
    async attestationOptions(opts) {
         ...
         * @property {String} [authenticatorSelection.authenticatorAttachment] What type of authenticatorAttachment is acceptable for new authenticators.
        ...
        setOpt(options, "challenge", coerceToBase64Url(challenge));
    ...
    async assertionOptions(opts) {
         ...
         * @property {Object} [extensions] The values of any enabled extensions.
         */
        // TODO fix tests in according to this changes of coerceToBase64Url
        setOpt(options, "challenge", coerceToBase64Url(challenge, "challenge"));
        setOpt(options, "timeout", this.config.timeout);
